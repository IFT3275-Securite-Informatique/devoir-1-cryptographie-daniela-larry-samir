...
def M_vers_symboles(M, K, dictionaire):
    """
    Convertit un message en symboles correspondant à une clé.
    
    :param M: Le message à encoder
    :param K: La clé
    :param dictionaire: Le dictionnaire de correspondances
    :return: Le message encodé en symboles
    """
    encoded_text = []
    i = 0
